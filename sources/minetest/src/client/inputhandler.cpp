...
extern void webxr_consume_mouse_delta(int &dx, int &dy);
#endif

v2s32 MyEventReceiver::getMouseMovement(bool reset)
{
#ifdef __EMSCRIPTEN__
	int xr_dx = 0, xr_dy = 0;
	webxr_consume_mouse_delta(xr_dx, xr_dy);
	v2s32 delta = v2s32(relX + xr_dx, relY + xr_dy);
#else
